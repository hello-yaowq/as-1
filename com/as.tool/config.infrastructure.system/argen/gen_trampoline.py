 ...
 * Automatically generated by goil on Tue May  2 18:41:26 2017
...
def Trampolone_TaskList(os_list):
    ret_list = []
...
#define WITH_ISR2_PRIORITY_MASKING       NO\n\n''');
    task_list = Trampolone_TaskList(os_list)
...
def genForTrampolone_H(gendir,os_list):
    fp = open('%s/Os_Cfg.h'%(gendir),'w')
    fp.write(__header)
    fp.write('#ifndef OS_CFG_H\n#define OS_CFG_H\n\n')
    fp.write('/* ============================ [ INCLUDES  ] ====================================================== */\n')
    fp.write('#include "Std_Types.h"\n')
    fp.write('#include "tpl_os_types.h"\n')
    fp.write('#include "tpl_os_definitions.h"\n')
    fp.write('#include "tpl_os_os.h"\n')
    fp.write('#include "tpl_os_event.h"\n')
    fp.write('#include "tpl_os_resource.h"\n')
    ...
    fp.close()
def genForTrampolone_C(gendir,os_list):
    ...
    fp.close()
def gen_trampolone(gendir,os_list):
    genForTrampolineMisc_H(gendir,os_list)
    genForTrampolone_H(gendir,os_list)
    genForTrampolone_C(gendir,os_list)
