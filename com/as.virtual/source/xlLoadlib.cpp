...
|
|-----------------------------------------------------------------------------
| $Author: vissj $    $Date: 2014-10-27 14:46:22 +0100 (Mo, 27 Okt 2014) $   $Revision: 36473 $
| $Id: xlLoadlib.cpp 36473 2014-10-27 13:46:22Z vissj $
|-----------------------------------------------------------------------------
...
XLstatus xlLoadLibrary(char *library){
  ...
  if (!hxlDll)
    hxlDll = LoadLibrary((LPCWSTR)library);
