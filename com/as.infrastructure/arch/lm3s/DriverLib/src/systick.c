...
//! an immediate reload is required, register NVIC_ST_CURRENT must be written
//! to force this.  Any write to this register clears the SysTick counter to
//! 0 and will cause a reload with the supplied period on the next clock.
//!
//! \return None.
//
//*****************************************************************************
...
//! immediately.  If an immediate reload is required, register NVIC_ST_CURRENT
//! must be written.  Any write to this register clears the SysTick counter to
//! 0 and will cause a reload with the \b ulPeriod supplied here on the next
