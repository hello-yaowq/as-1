...
//! \e ulProtocol can be one of the following values: \b SSI_FRF_MOTO_MODE_0,
//! \b SSI_FRF_MOTO_MODE_1, \b SSI_FRF_MOTO_MODE_2, \b SSI_FRF_MOTO_MODE_3,
//! \b SSI_FRF_TI, or \b SSI_FRF_NMW.  The Motorola frame formats imply the
...
//! \e ulMode can be one of the following values: \b SSI_MODE_MASTER,
