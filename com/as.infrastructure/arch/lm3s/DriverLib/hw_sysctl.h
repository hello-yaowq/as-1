...
#define SYSCTL_DID1_PKG_28SOIC  0x00000000  // SOIC
#define SYSCTL_DID1_PKG_48QFP   0x00000008  // QFP
...
#define SYSCTL_DC4_E1588        0x01000000  // EMAC 1588 capable
...
#define SYSCTL_RCC_XTAL_1MHZ    0x00000000  // Using a 1 MHz crystal
#define SYSCTL_RCC_XTAL_1_84MHZ 0x00000040  // Using a 1.8432 MHz crystal
#define SYSCTL_RCC_XTAL_2MHZ    0x00000080  // Using a 2 MHz crystal
#define SYSCTL_RCC_XTAL_2_45MHZ 0x000000C0  // Using a 2.4576 MHz crystal
#define SYSCTL_RCC_XTAL_3_57MHZ 0x00000100  // Using a 3.579545 MHz crystal
...
#define SYSCTL_RCC_XTAL_4MHz    0x00000180  // Using a 4 MHz crystal
#endif
#define SYSCTL_RCC_XTAL_4_09MHZ 0x000001C0  // Using a 4.096 MHz crystal
#define SYSCTL_RCC_XTAL_4_91MHZ 0x00000200  // Using a 4.9152 MHz crystal
#define SYSCTL_RCC_XTAL_5MHZ    0x00000240  // Using a 5 MHz crystal
#define SYSCTL_RCC_XTAL_5_12MHZ 0x00000280  // Using a 5.12 MHz crystal
#define SYSCTL_RCC_XTAL_6MHZ    0x000002C0  // Using a 6 MHz crystal
#define SYSCTL_RCC_XTAL_6_14MHZ 0x00000300  // Using a 6.144 MHz crystal
#define SYSCTL_RCC_XTAL_7_37MHZ 0x00000340  // Using a 7.3728 MHz crystal
#define SYSCTL_RCC_XTAL_8MHZ    0x00000380  // Using a 8 MHz crystal
#define SYSCTL_RCC_XTAL_8_19MHZ 0x000003C0  // Using a 8.192 MHz crystal
