...
#define SD_ENTRY_TYPE_1  1
#define SD_ENTRY_TYPE_2  2

#define SD_ENTRY_INVALID         -1
...
typedef union {
	Sd_Entry_Type1_Services type1;
	Sd_Entry_Type2_EventGroups type2;
} Sd_Entry_Type;

/* Datastructure for dynamic data used by state machine, generated by Sd generator */
extern const Sd_DynConfigType Sd_DynConfig;
extern const Sd_ConfigType *SdCfgPtr;
