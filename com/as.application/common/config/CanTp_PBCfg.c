...
SECTION_POSTBUILD_DATA const CanTp_NSduType CanTpNSduConfigList[] =
{
	{	/* pluginInstallationVCUCanTpRxNSdu */
		...
		/*lint -e651 */				
		.configData.CanTpRxNSdu.CanIf_FcPduId = 0,//TODO:CANIF_PDU_ID_PLUGINCOMMUNICATIONVCUTOTCUPDU,
		.configData.CanTpRxNSdu.PduR_PduId = 0,//TODO:PDUR_PDU_ID_PLUGININSTALLATIONVCUPDU,
