...
const NvM_BlockDescriptorType BlockDescriptorList[] = {

    {
        ...
        .NvBlockNum = FEE_BLOCK_ID_TIME,
        .NvramDeviceId = FEE_INDEX,
        .NvBlockBaseNumber = FEE_BLOCK_ID_TIME,
...

    {
        ...
        .CalcRamBlockCrc = FALSE, // TODO
        .NvBlockNum = FEE_BLOCK_ID_CONFIG,
        .NvramDeviceId = FEE_INDEX,
        .NvBlockBaseNumber = FEE_BLOCK_ID_CONFIG,
        .InitBlockCallback = NULL,
...

    {
        ...
        .CalcRamBlockCrc = FALSE, // TODO
        .NvBlockNum = FEE_BLOCK_ID_FINGER_PRINT,
        .NvramDeviceId = FEE_INDEX,
        .NvBlockBaseNumber = FEE_BLOCK_ID_FINGER_PRINT,
        .InitBlockCallback = NULL,
...

    {
        ...
        .CalcRamBlockCrc = FALSE, // TODO
        .NvBlockNum = EA_BLOCK_ID_EATEST1,
        .NvramDeviceId = EA_INDEX,
        .NvBlockBaseNumber = EA_BLOCK_ID_EATEST1,
        .InitBlockCallback = NULL,
...

    {
        ...
        .CalcRamBlockCrc = FALSE, // TODO
        .NvBlockNum = EA_BLOCK_ID_EATEST2,
        .NvramDeviceId = EA_INDEX,
        .NvBlockBaseNumber = EA_BLOCK_ID_EATEST2,
        .InitBlockCallback = NULL,
