...
static OS_STK          TaskStartStk[TASK_STK_SIZE];          /* Startup    task stack                         */
static OS_STK          TaskClkStk[TASK_STK_SIZE];            /* Clock      task stack                         */
static OS_STK          Task1Stk[TASK_STK_SIZE];              /* Task #1    task stack                         */
static OS_STK          Task2Stk[TASK_STK_SIZE];              /* Task #2    task stack                         */
static OS_STK          Task3Stk[TASK_STK_SIZE];              /* Task #3    task stack                         */
static OS_STK          Task4Stk[TASK_STK_SIZE];              /* Task #4    task stack                         */
static OS_STK          Task5Stk[TASK_STK_SIZE];              /* Task #5    task stack                         */

static TASK_USER_DATA  TaskUserData[7];

static OS_EVENT       *MsgQueue;                             /* Message queue pointer                         */
static void           *MsgQueueTbl[20];                      /* Storage for messages                          */
...
static  void  DispTaskStat(INT8U id);
...
static void  TaskClk (void *pdata)
{
    char  s[40];
